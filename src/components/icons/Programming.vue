...
<template>
  ...
  >
    <circle
      ...
      r="26.70075"
      fill="#f2f2f2"
      class="animate-horizontal-bounce-slow"
    />
    <path
    ...
    />
    <rect
      class="animate-horizontal-grow-1"
      x="209.38454"
      y="260.82713"
      width="50.71916"
      height="10.8457"
    ...
    />
    <rect
      class="animate-horizontal-grow-2"
      x="183.62601"
      y="282.51852"
      width="102.23622"
      height="10.8457"
    ...
    />
    <rect
      class="animate-horizontal-grow-2-fast"
      x="183.62601"
      y="304.20991"
      width="102.23622"
      height="10.8457"
...
.animate-horizontal-bounce-slow {
  animation: horizontal-bounce 4s ease-in-out infinite;
  transform-origin: center;
}

.animate-horizontal-grow-1 {
  animation: horizontal-grow 7s ease-in-out infinite;
  transform-origin: center;
}

.animate-horizontal-grow-2 {
  animation: horizontal-grow-2 7s ease-in-out infinite;
  transform-origin: center;
}

.animate-horizontal-grow-2-fast {
  animation: horizontal-grow-2 3s ease-in-out infinite;
  transform-origin: center;
}
</style>
